...
//    String STACK = "STACK";
    ...
    public void move (org.example.Card playablecard, org.example.Card targetcard) {
        ...
        if (playablecard.getLocation().equals(SPARE) && targetcard.getLocation().equals(GAME)) {
            ...
            if (targetcard.getValue().charAt(0) == '_') { // in case of empty column
            ...
            if (targetcard.getValue().charAt(0) != '_') { // if target is not an empty column
...
//        }
        ...
        if (playablecard.getValue().charAt(1) == 'K' && targetcard.getValue().charAt(0) == '_') {
            return true;
        }
